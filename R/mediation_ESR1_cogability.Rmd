...
load(file = "path/preprocessed_ESR1.RData")
...
all_data_new <- left_join(all_data_new, ESR1, by = "D_StdNr")
...
cor_table_cpgs <- all_data_new[, c("CpG+7_b", "CpG+10_b", "CpG+33_b", "CpG+41_b")]
cor<- Hmisc::rcorr(as.matrix(cor_table_cpgs))
cor$P # all r sig -> mean beta okay!
# remove hemimethylated mean beta values of CpGs
car::Boxplot(all_data_new$Mean_b, id=list(labels=all_data_new$D_StdNr)) # outliers there
...
colnames(corrtableXM) <- "ESR1 (N=157)"
...
#write.csv2(corrtable, file = "path/mediation_ESR1bisulfiteseq_IQ_corrtable_covvar_ESR1_IQnonlog_N157.csv")
...
#write.csv2(cond_effects_pcb77_cpath, file = "path/ESR1/cpath_pcb77.csv")
...
```{r post hoc mediation analyses}

load(file = "C:/Users/mattokhq/Desktop/05_Schadstoffstudie/R/cog_development/preprocess_BayleyU2U4_HAWIKU7.RData")
...
## PCDF118
model_pcdf118_BSIDmental24 <- '
          BSID_mental24_i ~ c*PCDF118c + sex_n + cw*PCDF118c:sex_n + b*Mean_M + BSID_mental12_i
          ...
          diffind := indirect0 - indirect1
          difftotal := total0 - total1' 
model_pcdf118_BSIDmental24.fit.YB <- sem(model_pcdf118_BSIDmental24, data = all_data_new_BSID, se = "bootstrap", bootstrap = 10000, test = "yuan.bentler", missing = "fiml.x")
summary(model_pcdf118_BSIDmental24.fit.YB, fit = TRUE, rsquar = TRUE)
parameterEstimates(model_pcdf118_BSIDmental24.fit.YB, ci = T, boot.ci.type = "bca.simple")

## PCDF121
model_pcdf121_BSIDmental24 <- '
          BSID_mental24_i ~ c*PCDF121c + sex_n + cw*PCDF121c:sex_n + b*Mean_M + BSID_mental12_i
          ...
          diffind := indirect0 - indirect1
          difftotal := total0 - total1' 
model_pcdf121_BSIDmental24.fit.YB <- sem(model_pcdf121_BSIDmental24, data = all_data_new_BSID, se = "bootstrap", bootstrap = 10000, test = "yuan.bentler", missing = "fiml.x")
...
pvalue_cw_FDR <- p.adjust(pvalues_all, method = "BH") # sig < .1 for PCDF118 & PCDF121
...
#save.image("path/mediation_ESR1bisulfitseq_IQ_image_nonlog2.RData")
